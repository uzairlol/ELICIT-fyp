#!/usr/bin/env python3
"""
Zero-contribution episode analysis for the locked 20260731 run.
Also supports R2 spike, warm-glow flags, and burst timing correlates.

Run from repo root:
  python "docs/raw documentation/20260731/scripts/analyze_20260731_zero_contributions.py"
"""
...
def main() -> None:
    ...
    summary = {
        ...
        "liquidity_note": (
            ...
            "true decision-time wealth may differ — treat as approximate."
        ),
    }
