#!/usr/bin/env python3
"""
Prompt 6: SI vs SFI language comparison for 20260731 reasoning corpora.

Run from repo root:
  python "docs/raw documentation/20260731/scripts/analyze_20260731_language.py"
"""
...
def keyness_bar(lod: pd.DataFrame, path: Path):
    ...
    ax.set_xlabel("z (log-odds SI − SFI)")
