# 06 â€” Agent Information Boundaries (20260804)

What agents can and cannot observe when deciding. Verified from prompts and feedback construction â€” **not** inferred from results fields alone.
...
| Qualitative â€œcontributions deposit into LDF poolâ€ | Yes (prompt reminder) | `_append_climate_role_guidance` |
...
Legend: **I** implemented in prompt Â· **P** soft guidance Â· **N** not shown

### Stage 0 â€” Institution
...
| Mode | Anonymity |
|------|-----------|
| LDF / climate | **Off** â€” real agent IDs |
...
T-1 peer block includes institution, wealth, contribution, received punish/reward, payoffs â€” **not** peersâ€™ assigned punish/reward maps.
...
| Other agentsâ€™ aggregate reputations | No |
...
| Export | **Not** in 20260804 results JSON |
...
| Aspect | Implemented |
|--------|-------------|
| Who proposes / votes | All agents (code); docstring â€œSI-onlyâ€ is inaccurate |
| Proposal text to voters | Full list + optional oracle annotation |
| Injection into Stage 0â€“2 cards | No â€” separate constitutional session |
...
| Institution/contrib history lists | Last 3 on cards | â‰¤10 stored |

Belief update itself uses a compact peer sample (top deviant contributors), not the full 25-peer dump â€” Prompt 1/prior engineering fix.  
...
| Behaviour | Type |
|-----------|------|
| Forced developedâ†’SI / developingâ†’SFI | Implemented |
| Hidden pool balance | Implemented information boundary |
| â€œContribute to LDF via emissions contributionâ€ reminder | Prompted |
