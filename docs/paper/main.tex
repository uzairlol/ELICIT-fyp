...
Social Pressure and Contribution Withdrawal\\
in Multi-Seed LLM Climate Societies}}

\author{
Uzair Arif\thanks{Corresponding author.}\\
...
\noindent\textbf{Keywords:} large language model agents; multi-agent systems; reputation; gossip; cooperation; climate risk sharing; endogenous institutions; public goods; multi-seed robustness
