...
In the primary climate runs, assignment is forced every round.
...
We track sanction burden as context rather than as the primary estimand.
...
The protocol does not retain a separate verbatim gossip transcript for every edge.
...
It is analyzed as backdrop for contribution dynamics and as a seed-sensitive political path.
...
Primary analyses treat each seed as a complete society under the same scientific protocol.
Inference emphasizes sign agreement across seeds for the focal social-pressure association.
Magnitude estimates from either seed alone remain uncertain because event cells are noisy and agents are interdependent within rounds.
