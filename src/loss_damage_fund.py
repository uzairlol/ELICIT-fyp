...
class LossDamageFund:
    ...
    def distribute_payouts(self, agents, damages):
        ...
        for agent in eligible_agents:
            dmg = max(0.0, damages.get(agent.agent_id, 0.0))
            ...
            weighted_need[agent.agent_id] = max(0.0, need)
        ...
        for agent in eligible_agents:
            ...
            max_for_agent = damages.get(aid, 0.0) * max(0.0, parameters.LDF_MAX_COVERAGE)
