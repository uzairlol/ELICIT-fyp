...
class OllamaClient:
    ...
    def _send_request_via_http(
        self, prompt, max_tokens=768, temperature=0.7, top_p=1.0, require_json=False
    ):
        """
        ...
        content = (
            (message.get("content") or response_data.get("response") or "").strip()
