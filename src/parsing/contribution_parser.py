...
from parsing.response_parsing_utils import _make_parser_meta, _unwrap_response_data
...
def parse_contribution_response_v2(response, agent):
    ...
    try:
        ...
        return (
            ...
            facts_used,
            deepseek_think,
            _make_parser_meta(data, expected_keys),
        )
        ...
        return (
            ...
            [],
            "",
            _make_parser_meta({}, expected_keys, True, f"Contribution parse exception: {e}"),
        )
