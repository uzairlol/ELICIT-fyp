...
In the action step, the agent samples its decision at from an LLM call given a contextual prompt that concatenates the outputs of all cognitive components with directed edges into the decision component:
...
## GossipExperimentResultsComparisonAcrossModels
...
- Fischbacher, U., G¨ achter, S., &amp; Fehr, E. (2001). Are people conditionally cooperative? evidence from a public goods experiment. Economics letters , 71 (3), 397-404.
...
- K¨ oster, R., Hadfield-Menell, D., Everett, R., Weidinger, L., Hadfield, G. K., &amp; Leibo, J. Z. (2022). Spurious normativity enhances learning of compliance and enforcement behavior in artificial agents. Proceedings of the National Academy of Sciences , 119 (3), e2106028118.
...
- Van Lange, P. A., Joireman, J., Parks, C. D., &amp; Van Dijk, E. (2013). The psychology of social dilemmas: A review. Organizational Behavior and Human Decision Processes , 120 (2), 125141.
- Vezhnevets, A. S., Agapiou, J. P., Aharon, A., Ziv, R., Matyas, J., Du´ e˜ nez-Guzm´ an, E. A., . . . Leibo,
